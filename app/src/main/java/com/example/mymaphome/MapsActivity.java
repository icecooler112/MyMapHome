...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        mpt1 = mMap.addMarker(new MarkerOptions().position(pt1)
            .position(pt1)
            .title("LPru")
            .snippet("มหาวิทยาลัยราชภัฎลำปาง")
            .icon(BitmapDescriptorFactory.defaultMarker(BitmapDescriptorFactory.HUE_GREEN)));

        mpt2 = mMap.addMarker(new MarkerOptions().position(pt2)
                .position(pt2)
                .title("EDU")
                .snippet("คณะครุศาสตร์")
                .icon(BitmapDescriptorFactory.defaultMarker(BitmapDescriptorFactory.HUE_RED)));

        mpt3 = mMap.addMarker(new MarkerOptions().position(pt3)
                .position(pt3)
                .title("comcentre")
                .snippet("ศูนย์คอม")
                .icon(BitmapDescriptorFactory.defaultMarker(BitmapDescriptorFactory.HUE_BLUE)));

        mpt4 = mMap.addMarker(new MarkerOptions().position(pt4)
                .position(pt4)
                .title("Management")
...
//        LatLng lpru = new LatLng(18.234556, 99.487362);
//        mMap.addMarker(new MarkerOptions()
//                .position(lpru)
//                .title("Marker in lpru")
//                .snippet("มหาวิทยาลัยราชภัฎลำปาง")
//               .icon(BitmapDescriptorFactory.defaultMarker(BitmapDescriptorFactory.HUE_VIOLET))//
//                .icon(BitmapDescriptorFactory.fromResource(R.drawable.pinn))
//        );
